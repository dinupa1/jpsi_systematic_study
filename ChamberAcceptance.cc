...
void xFAcceptance(TString var_name, double xmin, double xmax, TString kin_cuts, TString hist_name, TString target, TString particle, TString particle_MC, TString MC_data)
{
    gStyle->SetOptStat(0);
...
void pTAcceptance(TString var_name, double xmin, double xmax, TString kin_cuts, TString hist_name, TString target, TString particle, TString particle_MC, TString MC_data)
{
    gStyle->SetOptStat(0);
...
void ChamberAcceptance()
{
    ...
    for(int i = 0; i < 5; i++)
    {
        ...
        xFAcceptance("x2_st1", -30., 30., xF_cut, xF_hist2, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString xF_hist3 = Form("LH2_jpsi_y1_st1_xF%d", i);
        xFAcceptance("y1_st1", -60., 60., xF_cut, xF_hist3, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString xF_hist4 = Form("LH2_jpsi_y2_st1_xF%d", i);
        xFAcceptance("y2_st1", -60., 60., xF_cut, xF_hist4, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString xF_hist5 = Form("LH2_jpsi_x1_st3_xF%d", i);
        xFAcceptance("x1_st3", 0., 150., xF_cut, xF_hist5, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString xF_hist6 = Form("LH2_jpsi_x2_st3_xF%d", i);
        xFAcceptance("x2_st3", -150., 0., xF_cut, xF_hist6, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString xF_hist7 = Form("LH2_jpsi_y1_st3_xF%d", i);
        xFAcceptance("y1_st3", -150., 150., xF_cut, xF_hist7, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString xF_hist8 = Form("LH2_jpsi_y2_st3_xF%d", i);
        xFAcceptance("y2_st3", -150., 150., xF_cut, xF_hist8, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);
        ...
        pTAcceptance("x2_st1", -30., 30., pT_cut, pT_hist2, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString pT_hist3 = Form("LH2_jpsi_y1_st1_pT%d", i);
        pTAcceptance("y1_st1", -60., 60., pT_cut, pT_hist3, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString pT_hist4 = Form("LH2_jpsi_y2_st1_pT%d", i);
        pTAcceptance("y2_st1", -60., 60., pT_cut, pT_hist4, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString pT_hist5 = Form("LH2_jpsi_x1_st3_pT%d", i);
        pTAcceptance("x1_st3", 0., 150., pT_cut, pT_hist5, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString pT_hist6 = Form("LH2_jpsi_x2_st3_pT%d", i);
        pTAcceptance("x2_st3", -150., 0., pT_cut, pT_hist6, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);

        TString pT_hist7 = Form("LH2_jpsi_y1_st3_pT%d", i);
        pTAcceptance("y1_st3", -150., 150., pT_cut, pT_hist7, "targetPos==1", jPsiCut, jPsiCut_MC, LH2_jpsi_data);
